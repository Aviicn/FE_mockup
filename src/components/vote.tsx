      ...
      <div className="relative body">
        <div className="w-full p-8 mx-auto bg-white ">
          ...
          <div className='flex justify-center'>
            <div className="bgc2 flex  justify-center w-[466px] p-4 text-3xl h-[67px] rounded-lg mt-10 font-bold text-white hover:bg-lime-700">
              <button onClick={goToModal}>MASUKAN SUARAMU</button>
            </div>
          </div>
